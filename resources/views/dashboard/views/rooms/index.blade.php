                        ...
                        <tr class="tr-{{ $item->id }}">
                            ...
                            <td>
                                ...
                                @else
                                    ...
                                    @include('dashboard.components.imageModal', ['id' => $item->id,'img' => $item->getImageAttribute($item->main_image)])
                                @endif
                            </td>
                            <td>
                                ...
                                @else
                                    ...
                                    @include('dashboard.components.imageModal', ['id' => $item->id,'img' => $item->getImageAttribute($item->background)])
                                @endif
                            </td>
                            <td>
