...
<div class="form-group">
    ...
    <div class="{{App::getLocale() == 'ar' ? 'col-md-pull-2' : ''}} col-sm-10">
        {!!Form::text('password', isset($item->password) ? '' : NULL, array(isset($item->password) ? '' : 'required', 'id' => 'password', 'placeholder'=>__('dashboard.Password'), 'class'=>'form-control','style'=>'width: 120%'))!!}
    </div>
</div>
