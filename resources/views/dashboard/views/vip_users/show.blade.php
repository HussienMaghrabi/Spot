            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable_2">
                <thead>
                    <tr>
                        ...
                        <td>{{ $data->name }}</td>
                        <td>
                            <a href="{{ url(App::getLocale().'/dashboard/vip-users/'.$data->id.'/edit/name' ) }}" title="edit"><i class="fa fa-fw fa-edit text-warning"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ url(App::getLocale().'/dashboard/vip-users/'.$data->id.'/edit/special_id' ) }}" title="edit"><i class="fa fa-fw fa-edit text-warning"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <td>{{ $data->gender }}</td>
                        <td>
                            <a href="{{ url(App::getLocale().'/dashboard/vip-users/'.$data->id.'/edit/gender' ) }}" title="edit"><i class="fa fa-fw fa-edit text-warning"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <th>
